...
namespace UnitTests
{
    //Тесты связаные с заполнением книг
    [TestClass]
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void Can_Generate_Page_Links() //генерация ссылок на страницы
        {
        ...
        [TestMethod]
        public void Can_Send_Pagination_View_Model() //модель просмотра
        {
        ...
        [TestMethod]
        public void Can_Filter_Books() //разбиение книг по жанрам
        {
        ...
        [TestMethod]
        public void Can_Create_Categories() //создание жанров книг
        {
        ...
        [TestMethod]
        public void Indicates_Selected_Genre() //указатель на выбраный жанр
        {
        ...
        [TestMethod]
        public void Generete_Genre_Specific_Book_Count() //количество книг в определённом жанре
        {
